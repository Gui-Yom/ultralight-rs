...
pub use ultralight_sys::{JSType, JSTypedArrayType};
...
pub struct JSClass {
    pub raw: ultralight_sys::JSClassRef,
}
...
pub struct JSContext {
    pub raw: ultralight_sys::JSGlobalContextRef,
}
...
pub struct JSContextGroup {
    pub raw: ultralight_sys::JSContextGroupRef,
}
...
/// [`JSValue`]: struct.JSValue.html
pub struct JSObject {
    pub raw: ultralight_sys::JSObjectRef,
    pub value: JSValue,
}
...
#[derive(Eq)]
pub struct JSString {
    pub raw: ultralight_sys::JSStringRef,
}
...
#[derive(Debug)]
pub struct JSValue {
    pub raw: ultralight_sys::JSValueRef,
    pub ctx: ultralight_sys::JSContextRef,
}

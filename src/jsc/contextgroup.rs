...
impl JSContextGroup {
    ...
    pub fn new_context(&self) -> JSContext {
        JSContext {
            raw: unsafe { ultralight_sys::JSGlobalContextCreateInGroup(self.raw, ptr::null_mut()) },
        }
    }
    ...
    pub fn new_context_with_class(&self, global_object_class: &JSClass) -> JSContext {
        JSContext {
            raw: unsafe {
                ultralight_sys::JSGlobalContextCreateInGroup(self.raw, global_object_class.raw)
            },
        }
    }
}
...
impl Default for JSContextGroup {
    ...
    fn default() -> Self {
        JSContextGroup {
            raw: unsafe { ultralight_sys::JSContextGroupCreate() },
        }
    }
}
...
impl Drop for JSContextGroup {
    fn drop(&mut self) {
        unsafe { ultralight_sys::JSContextGroupRelease(self.raw) }
    }
}
